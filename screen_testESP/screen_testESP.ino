...
void loop() {
  ...
  if (readPMSdata(&pmsSerial)) {
    ...
    if (data.pm10_env != 0) {
      ...
      SCREEN_Write(0x30, data.particles_03um);  // 7398
      SCREEN_Write(0x40, data.pm100_env);       // 141
/////////////////////////////////////
      SCREEN_Serial_Write(0x10, data.pm25_env);                   // 127
      SCREEN_Serial_Write(0x20, (int)(MQ131.getO3(PPM) * 1000));  // 0.01241
      Serial.print("rounded o3: " + String((int)(MQ131.getO3(PPM) * 1000)));
      SCREEN_Serial_Write(0x30, data.particles_03um);  // 7398
      SCREEN_Serial_Write(0x40, data.pm100_env);       // 141
    }
    Serial.println();
